  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 p-4">
        {/* Icon */}
        <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-gold shadow-inner">
          {icon ? (
            <span className="text-lg" role="img" aria-hidden="true">{icon}</span>
          ) : (
            <Trophy className="size-5 text-clay-deep" />
          )}
        </div>
        ...
        <button
          type="button"
          onClick={dismiss}
          className="shrink-0 rounded-md p-1 text-muted-foreground transition-colors hover:text-brown"
      ...
      <div className="h-1 w-full bg-gold/20">
        <div
